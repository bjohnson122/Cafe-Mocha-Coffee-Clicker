...
// Next, we'll wire up the 'buy' buttons on the producers and set up a 'tick' function that 'runs' the producers, adding coffee automatically every second based on what producers the player has!
